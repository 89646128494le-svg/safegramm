...
REM Запуск Cloudflare Tunnel с явным указанием протокола
REM Используем просто tunnel без лишних параметров
%CLOUDFLARED_PATH% tunnel --url http://localhost:8080 --protocol http2

if errorlevel 1 (
    echo.
    echo Trying alternative method...
    echo.
    REM Альтернативный способ без указания протокола
